...
COPY PortfolioManager/PortfolioManager/pom.xml mymaven/pom.xml
COPY PortfolioManager/PortfolioManager/src mymaven/src
WORKDIR mymaven
...
COPY --from=compile mymaven/target/PortfolioManager-0.0.1-SNAPSHOT.jar app.jar
